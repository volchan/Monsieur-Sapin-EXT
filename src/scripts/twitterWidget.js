		 ...
		 */
                (function() {
                  ...
                  function D(t) {
                    ...
                    if (!$(t))
                      return (
                        I(i, new TypeError("You must pass an array to race.")),
                        i
                      );
                  ...
                  function U(t) {
                    (this._id = lt++),
                      ...
                      (this._subscribers = []),
                      v !== t &&
                        (o(t) || F(), this instanceof U || M(), k(this, t));
                  }
                  function q() {
                    var t;
            ...
            function(t, e, n) {
              function r(t) {
                return (
                  "string" == typeof t && C.test(t) && RegExp.$1.length <= 20
                );
              }
              function i(t) {
                  ...
                  return this._hydrated
                    ? this._insertedIntoDom
                      ? r._widget
                          ...
                          .then(e, n)
                      : n(
                          new Error("cannot render widget before DOM insertion")
                        )
                ...
                return (
                  ...
                  (!!c.asBoolean(d.val("dnt")) ||
                    (!!u.isUrlSensitive(e || s.host) ||
                      (!(
                        !a.isFramed() ||
                        !u.isUrlSensitive(a.rootDocumentLocation())
                      ) ||
            ...
            function(t, e, n) {
              ...
              function a(t, e) {
                var n = {};
                return (
                  (e = e || {}), (e.association_namespace = i(t)), (n[E] = e), n
                );
              }
              function u(t, e) {
              ...
              function r() {
                ...
                return (
                  ...
                  ("http:" !== f.protocol && "https:" !== f.protocol)
                    ...
                    : ((t = { origin: f.origin }),
                      (e = l.url(
                        m.resourceBaseUrl + m.widgetIframeHtmlPath,
                        t
                      )),
                      (n = function(t) {
                        var n;
                        if (e.substr(0, t.origin.length) === t.origin)
                          try {
                            (n = d.parse(t.data)),
                              n.namespace === v.settings &&
                                s.resolve(i(n.settings));
                          } catch (t) {}
                      }),
                      h.addEventListener("message", n),
                      (r = a({ src: e }, { display: "none" })),
            ...
            function(t, e) {
              t.exports = {
                tweetButtonHtmlPath:
                  "/widgets/tweet_button.36c0c29c73929bf937f4c70adb1a29e4.{{lang}}.html",
                followButtonHtmlPath:
                  "/widgets/follow_button.36c0c29c73929bf937f4c70adb1a29e4.{{lang}}.html",
                hubHtmlPath: "/widgets/hub.html",
                widgetIframeHtmlPath:
                  "/widgets/widget_iframe.36c0c29c73929bf937f4c70adb1a29e4.html",
            ...
            function(t, e, n) {
              function r(t) {
                ...
                if (t)
                  return (
                    (e = a([t])), { item_ids: Object.keys(e), item_details: e }
                  );
              }
              function i(t) {
            ...
            function(t, e, n) {
              ...
              function s(t, e) {
                ...
                (n = y.decodeURL(t.src).name),
                  ...
                  r >= o ||
                    ...
                    (t.src = y.url(i, { format: "jpg", name: S[s] })));
              }
              function a(t) {
              ...
              function m(t) {
                w.inlineStyle() ||
                  ...
                  p(t, ".MediaCard-mediaContainer", "paddingBottom", I),
                  p(t, ".CroppedImage-image", "top", C),
                  p(t, ".CroppedImage-image", "left", T));
              }
              var v = n(7),
                g = n(12),
                w = n(66),
              ...
              function r(t, e, n) {
                ...
                if (o)
                  return (r = d.createPlayerForTweet(o.element, e, o.options))
                    ...
                    : i.reject(
                        new Error("unable to create tweet video player")
                      );
              }
              function i(t, e, n) {
                var r,
                  ...
                  return (
                    ...
                    (this.playerInterface = {
                      ...
                      exitFullScreen: function() {
                        return (
                          this.jsonRpcCall("exitFullScreen"),
                          this.playerInterface
                        );
                      }.bind(this),
                      teardown: function() {
                ...
                t.params({
                  ...
                  t.define("injectWebIntentParams", function(t) {
                    ...
                    t.getAttribute(f) ||
                      ...
                      (t.href = u.url(t.href, {
                        tw_w:
                          this.params.dataSource && this.params.dataSource.id,
                ...
                t.params({
                  ...
                  t.define("_getWidgetQueryParams", function() {
                    var t =
                      ...
                      n =
                        this.params.profileShowReplies ||
                        this.params.showReplies,
                      r =
                        this.params.listOwnerUserId || this.params.listOwnerId;
                    return t || e
                      ? {
                          override_type: "user",
                          override_id: e,
            ...
            function(t, e, n) {
              function r(t) {
                var e = s(t),
                  ...
                  i = { url: r.href };
                return (
                  (i = o.aug({}, i, o.compact(e))), (i.dataSource = c(i)), i
                );
              }
              function i(t) {
                var e = a(t, d);
